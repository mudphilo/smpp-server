...
/**
 * Holds the values defined in the command status of the SMPP specification and other information that is used to build
 * the response that is sent to the client (e.g. the messageId).
 * 
