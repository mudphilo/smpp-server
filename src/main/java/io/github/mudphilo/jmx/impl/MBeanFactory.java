...
import static io.github.mudphilo.jmx.util.StringUtils.decapitalize;
...
import io.github.mudphilo.jmx.ManagementException;
import io.github.mudphilo.jmx.annotation.Description;
...
public final class MBeanFactory {
	...
	public static DynamicMBean createMBean(Object object) {
    	...
    	MethodHandler methodHandler = new MethodHandler(objectType);
    ...
    private static class MethodHandler {
    	 ...
    	 */
    	private final Collection<MBeanAttributeInfo> mBeanAttributes = new ArrayList<>();
    	 ...
    	 */
    	private final Collection<MBeanOperationInfo> mBeanOperations = new ArrayList<>();
    	 ...
    	 */
    	private MBeanParameterInfo[] buildMBeanParameters(Class<?>[] paramsTypes) {
